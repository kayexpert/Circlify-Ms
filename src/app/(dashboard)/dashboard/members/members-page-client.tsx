  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="visitors" className="space-y-4 mt-0">
          <Suspense fallback={<CompactLoader />}>
        ...
        <TabsContent value="birthdays" className="space-y-4 mt-0">
          <Suspense fallback={<CompactLoader />}>
        ...
        <TabsContent value="groups-departments" className="space-y-4 mt-0">
          <Suspense fallback={<CompactLoader />}>
