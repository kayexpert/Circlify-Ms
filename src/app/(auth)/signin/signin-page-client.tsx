    ...
    try {
      ...
      if (!client) {
        ...
        if (!supabaseUrl || !supabaseKey) {
          toast.error(
            "Configuration error: Supabase environment variables are not set. Please check your .env.local file."
          );
        } else {
          toast.error(
            "Failed to initialize authentication service. Please check your configuration."
          );
        }
        setIsLoading(false);
        return;
      ...
      // Always redirect to dashboard - let the dashboard layout handle the organization check
      // This is more reliable than checking here, as the dashboard layout runs in a more stable environment
      ...
      if (error instanceof Error) {
        ...
        if (
          ...
          message =
            "Unable to connect to authentication service. Please check your internet connection and ensure your Supabase environment variables are correctly configured.";
        } else {
